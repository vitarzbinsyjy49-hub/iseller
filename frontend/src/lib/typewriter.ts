...
/** Спокойный вариант — для строки поиска на ГЛАВНОЙ.
 *
 *  Внизу подсказка живёт в панели, которую человек открыл сам: он уже в поиске,
 *  и бежать ей незачем стесняться. Наверху она идёт фоном, пока человек
 *  осматривается, и на той же скорости выглядит суетливой — дёрганый текст в
 *  углу экрана перетягивает внимание с витрины.
 *
 *  Вдвое медленнее набор, вдвое медленнее стирание и заметно длиннее пауза с
 *  целой фразой: за неё подсказку успевают прочитать, не отрываясь от того, на
 *  что человек смотрел. Зазор с пустым полем тоже длиннее — пустая пауза и есть
 *  то, что читается как «спокойно», а не как мигание. */
export const TYPEWRITER_TIMING_CALM: TypewriterTiming = {
  typeMs: 118,
  deleteMs: 52,
  holdMs: 2600,
  gapMs: 700,
