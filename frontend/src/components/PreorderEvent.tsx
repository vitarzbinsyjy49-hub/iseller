...
/** Живой фон.
 *
 *  Цвета — те же, что у баннера события (scripts/compose_preorder_banner.py,
 *  палитра soft+). Кадр и экран обязаны звучать в один тон, иначе баннер
 *  выглядит вставленным из чужого проекта. Середина идёт через тёплый розовый,
 *  а не через серо-мовый: серо-мовый малонасыщен, и на нём весь фон сереет.
 *
 ...
 */
const BLOBS = [
  { x: 0.80, y: 0.08, r: 0.85, c: "163,157,219", a: 0.95 },  // лиловый
  { x: 0.14, y: 0.05, r: 0.72, c: "143,134,204", a: 0.80 },  // лиловый глубже
  { x: 0.22, y: 0.58, r: 0.88, c: "238,191,199", a: 0.90 },  // роза
  { x: 0.86, y: 0.80, r: 0.80, c: "250,228,199", a: 0.95 },  // крем
  { x: 0.50, y: 0.38, r: 0.45, c: "89,44,52", a: 0.08 },     // винный, еле слышно
];
