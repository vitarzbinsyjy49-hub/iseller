...
export default function Catalog() {
  ...
  return (
    <div className="mx-auto max-w-md lg:max-w-none">
      {/* Mobile: заголовка раздела здесь БОЛЬШЕ НЕТ, и это не упущение.
          «Каталог» уже написан на подсвеченной вкладке внизу, а выбранная
          категория — на активном чипе в панели ниже: крупная надпись повторяла
          и то и другое. Вдобавок она свободно уезжала под .hero-top-inset и
          обрубалась его кромкой — на видео это выглядело как «сверху появился
          белый таб». Так же устроены Telegram и Ozon: имя раздела живёт в
          навигации, контент начинается сразу.
          На desktop заголовок остаётся (title row ниже): там нет ни вкладок,
          ни полосы, и колонке контента нужна своя подпись. */}
