...
def main() -> int:
    ...
    phones, failed_phones = parse((DATA / "bsa_2026_08_18.txt").read_text(encoding="utf-8"))
    macs, failed_macs = parse_mac((DATA / "bsa_mac_2026_08_18.txt").read_text(encoding="utf-8"))
