...
class Product(Base):
    ...
    # Редакторское продвижение: чем больше, тем выше в выдаче, СРАЗУ после
    # наличия и ДО спроса (services/ranking). Нужен на запуск новой модели: у
    # неё ещё нет просмотров, и честная популярность держала бы её под прошлым
