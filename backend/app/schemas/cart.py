...
class CheckoutIn(BaseModel):
    ...
    # Сколько баллов списать. Присланному числу верим только в одну сторону:
    # потолок считает сервер, и всё сверх него — отказ, а не молчаливое
    # усечение. Усечение выглядит как скидка, которой человек не просил.
    points_to_spend: int = Field(default=0, ge=0, le=10_000_000)
