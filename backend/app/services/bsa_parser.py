...
#: Цена: либо с разделителями разрядов («2.800.000», «76 000»), либо сплошным
#: числом. Верхняя граница сплошного числа — 9 цифр, а не 6: у поставщика
#: семизначные цены пишутся и без разделителей («1020000»), и прежний предел
#: обрезал такую строку до шести цифр, превращая 1 020 000 в 102 000.
_PRICE_RE = re.compile(r"(\d{1,3}(?:[.\s]\d{3})+|\d{4,9})")
#: Суффикс объёма («256Gb») — необязательный. BSA начал писать его в выгрузке
